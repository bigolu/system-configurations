...
local groups = {
  ...
  MiniDiffSignAdd = { ctermfg = 2, fg = colors[2], reverse = true },
  MiniDiffSignChange = { ctermfg = 3, fg = colors[3], reverse = true },
  MiniDiffSignDelete = { ctermfg = 1, fg = colors[1], reverse = true },
